          ...
          <div className="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className='hidden md:block'>
              ...
              <p className="inline-block text-sm font-medium bg-clip-text bg-linear-to-l from-blue-600 to-violet-500 text-transparent dark:from-blue-400 dark:to-violet-400">
               ...
               Por que <strong>zylogi?</strong>
              </p>

              {/* Title */}
              <div className="mt-4 md:mb-12 max-w-2xl">
                <h1 className="mb-4 font-semibold text-gray-800 text-4xl lg:text-5xl dark:text-neutral-200">
                  Totalmente acertivo, dinâmico e reponsivo.
                </h1>
                <p className="text-gray-600 dark:text-neutral-400">
                  Um leque de ferramentas poderosas, para fazer sua empresa cada vez mais moderna, segura e escalável. Acompanhar, delegar, gerir ficou ainda mais fácil.
                </p>
              </div>
              </div>
              ...
              <blockquote className="hidden md:block relative max-w-sm">
                ...
                <div className="relative z-10">
                  <p className="text-xl italic text-gray-800 dark:text-white">
                    Agilidade na informação, excelente dinâmismo de processos e excelentes indicadores!
                  </p>
                </div>
                ...
                <footer className="mt-3">
                  <div className="flex items-center gap-x-4">
                    ...
                    <div className="grow">
                      <div className="font-semibold text-gray-800 dark:text-neutral-200">João da Silva</div>
                      <div className="text-xs text-gray-500 dark:text-neutral-500">Diretor Operacional | ExpoTrans</div>
                    </div>
                  </div>
                </footer>
              </blockquote>
            ...
            <div>
              <LoginForm /> {/* Usando o componente LoginForm aqui */}
            </div>
            {/* End Col */}
          </div>
          {/* End Grid */}
